...
orderDetailsRouter.delete('/delete/:id', authenticateToken, authorizeRole(['UserSuperAdmin']), controller.delete);                            // Delete a OrderDetails by ID

// PATCH Used for Parcial Update (Authentication Required - Token)
orderDetailsRouter.patch('/update-cart', authenticateToken, authorizeRole(['UserSuperAdmin']), controller.updateCart);                        // Update Cart Status by ID
orderDetailsRouter.patch('/update-status', authenticateToken, authorizeRole(['UserSuperAdmin']), controller.updateStatus);                    // Update OrderDetails Status by ID
