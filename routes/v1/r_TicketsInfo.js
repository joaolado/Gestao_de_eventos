...
ticketsInfoRouter.delete('/delete/:id', authenticateToken, authorizeRole(['UserSuperAdmin']), controller.delete);                            // Delete a TicketsInfo by ID

// PATCH Used for Parcial Update (Authentication Required - Token)
ticketsInfoRouter.patch('/restore/:id', authenticateToken, authorizeRole(['UserSuperAdmin']), controller.restore);                           // Restore TicketsInfo by ID
ticketsInfoRouter.patch('/update-status', authenticateToken, authorizeRole(['UserSuperAdmin']), controller.updateStatus);                    // Update TicketsInfo Status by ID
